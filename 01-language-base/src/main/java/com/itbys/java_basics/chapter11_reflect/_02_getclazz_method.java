...
public class _02_getclazz_method {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        //
        Class<?> clazz03 = Class.forName("com.itbys.java_basics.chapter11_reflect.Person");

        //类的加载器
        ClassLoader classLoader = Person.class.getClassLoader();
        Class<?> clazz04 = classLoader.loadClass("com.itbys.java_basics.chapter11_reflect.Person");
